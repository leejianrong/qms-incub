...
| Frontend (Svelte+Vite) | V1's chat panel, plus Tailwind + shadcn-svelte (V12, ADR-0013) and V2/V4/V9's routes: `/editor` (Standard/Clause/Requirement), `/wizard` (2-phase: name + optional AOR upload with a "read from the pack" panel, then the 3 classification questions), `/project?id=` (V10's two-pane plan navigator, todo detail panel includes V11's approval-route card). No unified console shell yet — that's V13 |
...
| Everything else in PLAN.md / SLICES.md (V6, V8, V13) | **Not built yet.** |
